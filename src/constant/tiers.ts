...
export const SUB_TIERS: Record<SubTierCode, SubTierMeta> = {
    VISITOR: { code: 'VISITOR', group: 'visitor', label: 'Visitor', tokens: 1, price_cents: 0 },
    R1: { code: 'R1', group: 'red', label: 'R1', tokens: 1, price_cents: 1000 },
    R4: { code: 'R4', group: 'red', label: 'R4', tokens: 4, price_cents: 2000 },
    R7: { code: 'R7', group: 'red', label: 'R7', tokens: 7, price_cents: 3000 },
    B1: { code: 'B1', group: 'blue', label: 'B1', tokens: 1, price_cents: 2600 },
    B4: { code: 'B4', group: 'blue', label: 'B4', tokens: 4, price_cents: 3900 },
    B7: { code: 'B7', group: 'blue', label: 'B7', tokens: 7, price_cents: 5200 },
    B10: { code: 'B10', group: 'blue', label: 'B10', tokens: 10, price_cents: 6500 }
};
